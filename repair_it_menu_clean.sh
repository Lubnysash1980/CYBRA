...
echo "=== REPAIR CYBRA IT MENU CLEAN ==="

mkdir -p data/cybra_it_menu/tasks data/cybra_it_menu/sent data/cybra_it_menu/completed data/cybra_it_menu/reports posts feeds proofs runtime/redis logs
...
chmod +x cybra_it_menubar.py cybra_it_menu.sh
ln -sf "$HOME/CYBRA/cybra_it_menu.sh" "$PREFIX/bin/cybra-it-menu" 2>/dev/null || true
ln -sf "$HOME/CYBRA/cybra_it_menu.sh" "$PREFIX/bin/cybra-it-bar" 2>/dev/null || true

python3 -m py_compile cybra_it_menubar.py || exit 1

bash cybra_it_menu.sh report
bash cybra_it_menu.sh counts

echo
echo "✅ IT MENU REPAIRED"
echo "Run:"
echo "  cybra-it-menu"
echo "  cybra-it-menu counts"
echo "  cybra-it-menu list"
