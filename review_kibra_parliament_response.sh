...
echo "=== 1. DRAIN QUEUE / RUN WORKER ==="
redis-cli ping >/dev/null 2>&1 || redis-server --daemonize yes
cybra worker-start || true
sleep 8

echo
echo "=== 2. REFRESH REPORTS ==="
...
mkdir -p posts feeds proofs logs/kibra

cat > cybra_parliament_kibra_review.py <<'PY'
#!/usr/bin/env python3
...
python3 cybra_parliament_kibra_review.py
