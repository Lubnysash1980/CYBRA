...
def execute(task):
    ...
    if not cmd:
        return {
            ...
            "message": "Задача прийнята, але для цього type ще немає дозволеного executor mapping."
        }
...
print("=== CYBRA PARLIAMENT EXECUTOR V2 STARTED ===")
...
while True:
    ...
    try:
        ...
        fail = {"raw": raw, "hash": h, "error": str(e), "time": time.time()}
